...
gui_select -rect {622.555 461.322 78.992 -65.567}
fit
deselectAll
selectMarker 330.1500 298.8000 1201.2000 1201.2000 -1 3 7
...
getCTSMode -engine -quiet
getCTSMode -engine -quiet
gui_select -rect {687.304 756.411 806.349 753.577}
verifyConnectivity -type all -noAntenna -noWeakConnect -connLoop -error 1000 -warning 50
verifyConnectivity -type all -geomLoop -error 1000 -warning 50
deselectAll
selectInst {I0/LD/T_FIFO/IP_FIFO/UFIFORAM/fiforeg_reg[6][2]}
fit
